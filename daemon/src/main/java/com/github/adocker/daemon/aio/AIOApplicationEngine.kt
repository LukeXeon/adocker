...
import com.github.adocker.daemon.aio.backend.port
import com.github.adocker.daemon.aio.backend.unixSocketServer
...
import io.ktor.server.cio.UnixSocketConnectorConfig
...
class AIOApplicationEngine(
    ...
    private fun addHandlerForExpectedHeader(output: ByteWriteChannel, call: AIOApplicationCall) {
        ...
        call.request.pipeline.insertPhaseBefore(
    ...
    private fun hasBody(request: AIOApplicationRequest): Boolean {
